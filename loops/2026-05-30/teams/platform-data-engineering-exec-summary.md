...
- **`<verified-against-rust-impl: pending>` → `verified` tag flip** in Kafka contract §2.1. Byte-stability for Example A confirmed by resink-core's supervisor 2026-05-23; pure housekeeping single-line edit. Carries to loop 2026-06-06 (or whenever §2.1 gets touched again).
