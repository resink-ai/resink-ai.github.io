...
Parent: `board/okrs/2026-05-10-ceo-brief.md` — O2 KR2.1.
...
- KR1.4: A "deferred to next loop" subsection lists the work this team scopes for loop 2026-05-23 — including submodule promotion of `repos/resink-ai/resink-core/`, the actual implementation of the first build slice, and any next-cut design questions surfaced this loop.
...
Parent: `board/okrs/2026-05-10-ceo-brief.md` — O2 KR2.3.
...
**What ships next loop (loop 2026-05-23):**
