...
> - **Three helm gates** (`lint --strict`, `template`, `install --dry-run=client --debug`) — ✅ exit 0 on the updated chart + new `values.schema.json` (verified loop 2026-05-11-1631).
