...
- **From `teams/application/resink-core`, no this-loop ask.** Resink-core's consolidation work (brief O1) does not consume Bundle B's ritual edits — the rituals are agent-runtime artifacts that take effect starting loop 2026-05-30. The non-`--bare` invocation form remains unchanged this loop per the brief's strict ADR-002 floor; the addendum that documents it is brief-deferred to 2026-05-30.
...
- **Bundle C (5 tasks: T13–T17 — roles + README + worked-flow walks).** Earliest target loop 2026-05-30 per the 2026-05-16 OKR's framing and this loop's brief deferral.
