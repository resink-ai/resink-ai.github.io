...
- **Ratify the 2026-05-23 ADR batch.** Six ADRs flip to `active` this loop, ordered to minimize merge friction:
  ...
  5. [`2026-05-16-001-abi-option-a-mvp-deviation`](../decisions/2026-05-16-001-abi-option-a-mvp-deviation.md) — ratifies Option A; names the multi-loop `dlopen` restoration plan (AE template extension loop 2026-05-11-1302; resink-core supervisor swap loop 2026-05-11-1631; hot-swap test loop after).
...
- KR5.4: A backlink in SRE's `status.md` once the runbook lands; the runbook is the team's primary owned-surface artifact through loop 2026-05-11-1302.
