...
- **Timing:** **Picked up loop 2026-05-11-1302.** Sized M; sim-farm's main loop work plus a 2-week-old retro item should fit comfortably alongside Mode-B scoping start. Resink-core's dim_account fixture migrates back to its canonical shape (account_id PK, real `account_type`/`status` columns) once the engine is schema-aware.
...
- **Timing:** **Picked up loop 2026-05-11-1302** (resink-core's KR2.1 third attempt).
...
- **Timing:** **Picked up loop 2026-05-11-1302** so DevOps's KR4.3 closes.
...
- **Timing:** **Picked up loop 2026-05-11-1302** alongside the existing 2026-05-30 batch (ADR-2026-05-16-003 contract-environment-verification, ADR-2026-05-16-004 focus-loop pattern, AE's DISPATCH.md `--bare` addendum, AE's Bundle C). Sized XS.
...
- **Owner:** board.
- **Timing:** **Picked up loop 2026-05-11-1302** as part of ADR-2026-05-16-004 ratification work.

## Decisions to record

New ADRs this loop:

- **ADR `2026-05-23-001` (P4)** "Extend conventions type enum (runbook + possibly batched additions)." Draft placeholder at [`board/decisions/2026-05-23-001-conventions-enum-extension.md`](../decisions/2026-05-23-001-conventions-enum-extension.md). Status: `draft`. Owner: board. Picked up loop 2026-05-11-1302. Class: org-os.
