...
Why it matters: A diff engine that nobody calls does not close the loop. Resink-core owns the `make mvp-loop` driver per CEO brief [O1 KR1.1](../../../../board/okrs/2026-05-16-ceo-brief.md) and we own its final step per [O2 KR2.3](../../../../board/okrs/2026-05-16-ceo-brief.md); the invocation shape is a coordination point, not a sim-farm-only decision. The charter touch-up is required by [O2 KR2.4](../../../../board/okrs/2026-05-16-ceo-brief.md) and also clears a carryover from the 2026-05-10 OKR (KR3.1 charter update never landed).
