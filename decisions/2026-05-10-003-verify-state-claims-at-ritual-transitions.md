...
- **Follow-ups required:** Update exec-summary, ceo-brief, and ceo-consolidation ritual files (this loop). Loop 2026-05-23 is the first loop the convention applies to authoring; loop 2026-05-30 retro evaluates whether the text convention has caught any near-misses or whether Phase 2 tooling needs to escalate.

## Links

- Triggering retro: [board/retros/2026-05-10-ceo-retro.md](../retros/2026-05-10-ceo-retro.md) (P1)
- Driving incident: loop 2026-05-10 mid-loop ADR-001-on-master gate slip — see [board/exec-summaries/2026-05-10.md](../exec-summaries/2026-05-10.md) § "Cross-cutting blockers"
