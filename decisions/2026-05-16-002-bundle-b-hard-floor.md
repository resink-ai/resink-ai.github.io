...
- Triggering retro: board/retros/2026-05-11-0958-ceo-retro.md — P2.
- Related ADRs: 2026-05-09-001-org-os-bottom-up-flow (the 17-task plan B implements); 2026-05-10-003-verify-state-claims-at-ritual-transitions (sibling 2026-05-23 ritual edit).
...
- AE's 2026-05-16 exec summary flagging the pattern: `teams/platform/agent-engineering/exec-summaries/2026-05-11-0958.md`.
{% endraw %}
